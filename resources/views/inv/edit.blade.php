                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('inv.update', $test->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="testDate" type="text" class="form-control @error('testDate') is-invalid @enderror" name="testDate" value="{{ $test->testDate }}" autocomplete="testDate" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="Cpeptide" type="text" class="form-control @error('Cpeptide') is-invalid @enderror" name="Cpeptide" value="{{ $test->Cpeptide }}" autocomplete="Cpeptide" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="hba1c" type="text" class="form-control @error('hba1c') is-invalid @enderror" name="hba1c" value="{{ $test->hba1c }}" autocomplete="hba1c" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cholesterol" type="text" class="form-control @error('cholesterol') is-invalid @enderror" name="cholesterol" value="{{ $test->cholesterol }}" autocomplete="cholesterol" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="hdl" type="text" class="form-control @error('hdl') is-invalid @enderror" name="hdl" value="{{ $test->hdl }}" autocomplete="hdl" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ldl" type="text" class="form-control @error('ldl') is-invalid @enderror" name="ldl" value="{{ $test->ldl }}" autocomplete="ldl" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tg" type="text" class="form-control @error('tg') is-invalid @enderror" name="tg" value="{{ $test->tg }}" autocomplete="tg">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ratio" type="text" class="form-control @error('ratio') is-invalid @enderror" name="ratio" value="{{ $test->ratio }}" autocomplete="ratio">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cr" type="text" class="form-control @error('cr') is-invalid @enderror" name="cr" value="{{ $test->cr }}" autocomplete="cr">
