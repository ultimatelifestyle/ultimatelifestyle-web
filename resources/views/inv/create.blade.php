                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('inv.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nextTest" type="text" class="form-control @error('nextTest') is-invalid @enderror" name="nextTest" value="{{ old('nextTest') }}" autocomplete="nextTest">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="Cpeptide" type="text" class="form-control @error('Cpeptide') is-invalid @enderror" name="Cpeptide" value="{{ old('Cpeptide') }}" autocomplete="Cpeptide" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="hba1c" type="text" class="form-control @error('hba1c') is-invalid @enderror" name="hba1c" value="{{ old('hba1c') }}" autocomplete="hba1c" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cholesterol" type="text" class="form-control @error('cholesterol') is-invalid @enderror" name="cholesterol" value="{{ old('cholesterol') }}" autocomplete="cholesterol" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="hdl" type="text" class="form-control @error('hdl') is-invalid @enderror" name="hdl" value="{{ old('hdl') }}" autocomplete="hdl" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ldl" type="text" class="form-control @error('ldl') is-invalid @enderror" name="ldl" value="{{ old('ldl') }}" autocomplete="ldl" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tg" type="text" class="form-control @error('tg') is-invalid @enderror" name="tg" value="{{ old('tg') }}" autocomplete="tg">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ratio" type="text" class="form-control @error('ratio') is-invalid @enderror" name="ratio" value="{{ old('ratio') }}" autocomplete="ratio">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cr" type="text" class="form-control @error('cr') is-invalid @enderror" name="cr" value="{{ old('cr') }}" autocomplete="cr">
                       ...
                       <div class="collapse multi-collapse" id="multiCollapseExample1">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="tsh" type="text" class="form-control @error('tsh') is-invalid @enderror" name="tsh" value="{{ old('tsh') }}" autocomplete="tsh">
