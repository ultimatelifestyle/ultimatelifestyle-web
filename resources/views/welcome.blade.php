...
<div class="container">
  @include('layouts.inc.message')
                <div class="jumbotron">
                    ...
                    <span> Dr.Kyaw Soe & Sita </span>
                    <p class="lead">
                      @guest
                        <a class="btn btn-primary btn-lg" href="{{url('/register')}}" role="button">အကောင့်ဖွင့်ပါ</a>
                      @else    
                        <a class="btn btn-primary btn-lg" href="{{url('/home')}}" role="button">Dashboard</a>
                        <a class="btn btn-primary btn-lg" href="{{route('rec.create')}}" role="button">Add New Record</a>
                      @endguest
                    </p>
                </div>
